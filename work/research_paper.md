...
### 5.2 What does the ranking buy when review capacity is limited?
...
### 6.1 High-ranked false positives
...
## 7. From Risk Score to Human Action
...
*External research references will be added after the final literature pass. They will be used to support methodological context such as grouped validation under distribution shift, ranking under limited review budgets, error analysis, and reproducibility. They will not be used to replace or inflate the project's own empirical claims.*
